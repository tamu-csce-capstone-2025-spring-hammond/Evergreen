    ...
    return (
        ...
        >
            ...
            <div className="mt-4 flex gap-10 text-[28px] w-full">
                <button className="flex-1 py-2 border border-gray-500 text-center">Deposit</button>
                <button className="flex-1 py-2 border border-gray-500 text-center">Withdraw</button>
            </div>
