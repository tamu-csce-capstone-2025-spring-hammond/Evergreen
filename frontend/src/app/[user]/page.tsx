      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 grid grid-rows-[5fr_4fr] grid-cols-[3fr_2fr] gap-4 p-4 overflow-hidden">
            ...
            <div className="overflow-hidden flex flex-col">
                ...
                <PortfolioList home={true} cards={exampleCards} selectedCardName={undefined}/> {/* TODO: Add the OnClick function here too - send to portfolio page with the clicked portfolio selected */}
            </div>
            <News />
        </div>
      </div>
